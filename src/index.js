...
const tests = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    /**
     * access tokens should be short lived, refresh tokens should be long lived
     * when the access token expires, the refresh token can be used to get a new
     * access token.
     *
     * a logout route should invalidate the refresh token, meaning no new access
     * tokens can generated by it. Meaning that a full 'log in' is required again
     */
    // todo re-write the server to show basic JWT auth usage. Should be more like 
    // a reference tool
});
